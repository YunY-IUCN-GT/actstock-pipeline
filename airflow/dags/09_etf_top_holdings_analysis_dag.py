...
def check_data_availability(**context):
    ...
    try:
        # Check ETF metadata
        etf_count_query = "SELECT COUNT(*) as cnt FROM collected_meta_etf"
        ...
        holdings_query = "SELECT COUNT(*) as cnt FROM collected_etf_holdings"
...
def verify_results(**context):
    ...
    try:
        ...
        if not results:
            raise ValueError("No results found in analytics_etf_top_holdings")
